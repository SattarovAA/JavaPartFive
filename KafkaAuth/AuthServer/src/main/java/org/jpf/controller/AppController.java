...
public class AppController {
     ...
     */
    @Operation(summary = "Testing endpoint with public access.",
     ...
     */
    @Operation(summary = "Testing endpoint with admin access.",
     ...
     */
    @Operation(summary = "Testing endpoint with manager access.",
            tags = {"test", "get", "access"})
    @ApiResponse(responseCode = "200")
    @ApiResponse(responseCode = "403")
    @ApiResponse(responseCode = "404")
     ...
     */
    @Operation(summary = "Testing endpoint with user access.",
            tags = {"test", "get", "access"})
    @ApiResponse(responseCode = "200")
    @ApiResponse(responseCode = "403")
    @ApiResponse(responseCode = "404")
     ...
     */
    @Operation(summary = "Testing endpoint with any auth access.",
