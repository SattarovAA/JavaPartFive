...
public class JwtTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (request.getServletPath().contains("/v3/api-docs")
            ...
            log.info("doFilterInternal swagger message");
        ...
        try {
            ...
            if (jwtToken != null && jwtUtils.validation(jwtToken)) {
                String subject = jwtUtils.getSubjectFromJwtToken(jwtToken);
                AppUserDetails userDetails =
                        (AppUserDetails) userDetailsService.loadUserByUsername(subject);
